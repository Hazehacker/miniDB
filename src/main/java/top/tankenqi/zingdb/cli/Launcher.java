...
import top.tankenqi.zingdb.cli.ui.TerminalCaps;
import top.tankenqi.zingdb.cli.ui.Theme;
import top.tankenqi.zingdb.engine.net.Encoder;
import top.tankenqi.zingdb.engine.net.Package;
import top.tankenqi.zingdb.engine.net.Packager;
import top.tankenqi.zingdb.engine.net.Transporter;
...
public class Launcher {
    ...
    private static void runOneShot(Client client, String sql) {
        try {
            ...
            System.out.println(top.tankenqi.zingdb.cli.ui.TableRenderer.render(resp));
