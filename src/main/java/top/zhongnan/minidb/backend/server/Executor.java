package top.zhongnan.minidb.backend.server;

import java.nio.charset.StandardCharsets;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

import top.zhongnan.minidb.backend.parser.Parser;
...
import top.zhongnan.minidb.backend.tbm.BeginRes;
import top.zhongnan.minidb.backend.tbm.TableManager;
import top.zhongnan.minidb.common.Error;
import top.zhongnan.minidb.common.MiniDBException;
import top.zhongnan.minidb.transport.ColumnType;
import top.zhongnan.minidb.transport.Package;
import top.zhongnan.minidb.transport.ResultSet;
...
public class Executor {
    ...
    private static Package toErrorPackage(Exception e) {
        if (e instanceof MiniDBException) {
            MiniDBException z = (MiniDBException) e;
