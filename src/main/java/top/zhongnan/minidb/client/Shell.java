...
import top.zhongnan.minidb.client.ui.Ansi;
import top.zhongnan.minidb.client.ui.Banner;
import top.zhongnan.minidb.client.ui.HelpPrinter;
import top.zhongnan.minidb.client.ui.MetaCommand;
import top.zhongnan.minidb.client.ui.Prompter;
import top.zhongnan.minidb.client.ui.TableRenderer;
import top.zhongnan.minidb.client.ui.Theme;
 ...
 * 关键行为：
 *   1. 多行输入：以 ";" 结尾或元命令一行提交。
 *   2. 历史持久化在 ~/.minidb_history（JLine 自带）。
 *   3. Tab 补全：SQL 关键字 + 已知元命令；不查表名（避免每次都打到服务端）。
 *   4. 提示符颜色根据事务状态变化：默认青色 minidb> / 事务黄色 minidb* / 错误红色 minidb!
...
public class Shell {
    ...
    private void runWith(Terminal terminal) {
        ...
        LineReader reader = LineReaderBuilder.builder()
            ...
            .variable(LineReader.HISTORY_FILE, System.getProperty("user.home") + "/.minidb_history")
