...
import top.zhongnan.minidb.client.ui.TerminalCaps;
import top.zhongnan.minidb.client.ui.Theme;
import top.zhongnan.minidb.transport.Encoder;
import top.zhongnan.minidb.transport.Package;
import top.zhongnan.minidb.transport.Packager;
import top.zhongnan.minidb.transport.Transporter;

/**
 * 客户端入口。
 *
 * 用法：
 *   minidb-client [--host HOST] [--port PORT] [--no-color] [-e SQL] [-f FILE]
 *
...
public class Launcher {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            new HelpFormatter().printHelp("minidb-client", opts);
            System.exit(2);
            return;
        }
    ...
    private static void runOneShot(Client client, String sql) {
        try {
            ...
            System.out.println(top.zhongnan.minidb.client.ui.TableRenderer.render(resp));
