...
import top.zhongnan.minidb.cli.ui.TerminalCaps;
import top.zhongnan.minidb.cli.ui.Theme;
import top.zhongnan.minidb.engine.net.Encoder;
import top.zhongnan.minidb.engine.net.Package;
import top.zhongnan.minidb.engine.net.Packager;
import top.zhongnan.minidb.engine.net.Transporter;
...
public class Launcher {
    ...
    private static void runOneShot(Client client, String sql) {
        try {
            ...
            System.out.println(top.zhongnan.minidb.cli.ui.TableRenderer.render(resp));
